...
namespace Tubudu\Weather;

use GuzzleHttp\Client;
use Tubudu\Weather\Exceptions\Exception;
use Tubudu\Weather\Exceptions\HttpException;
use Tubudu\Weather\Exceptions\InvalidArgumentException;
